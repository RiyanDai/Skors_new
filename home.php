...
<main id="main">
    ...
    <div class="container">
      <header class="section-header">
        ...
        <p>"Perjalanan kami dimulai pada tahun 2020 dengan lahirnya Skor, sebuah platform manajemen performa bisnis
          ...
          berkomitmen untuk mendukung pertumbuhan dan kesuksesan usaha. Hingga hari ini, Skor terus berkembang dengan
          misi untuk memberdayakan bisnis dalam menghadapi tantangan dan mencapai potensi terbaiknya." </p>
      </header>
  ...
  <section id="clients" class="wow fadeInUp">
    <div class="container">
      ...
      <div class="owl-carousel clients-carousel">
        <img src="<?php echo get_theme_file_uri('/img/clients/client-1.png'); ?>" alt="">
        <img src="<?php echo get_theme_file_uri('/img/clients/client-2.png'); ?>" alt="">
        <img src="<?php echo get_theme_file_uri('/img/clients/client-3.png'); ?>" alt="">
        <img src="<?php echo get_theme_file_uri('/img/clients/client-4.png'); ?>" alt="">
  ...
  <section id="contact" class="section-bg wow fadeInUp">
    <div class="container">
      ...
      <div class="form">
        <div id="sendmessage" class="alert alert-success" style="display:none;">Your message has been sent. Thank you!</div>
